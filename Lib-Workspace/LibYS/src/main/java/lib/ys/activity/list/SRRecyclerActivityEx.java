 ...
 * @author yuansui
 */
abstract public class SRRecyclerActivityEx<T> extends RecyclerActivityEx<T> implements OnSRWidgetListener {

    private SRWidget<T> mSRWidget = new SRWidget<T>(this, getWidget());
