...
//	private static final String TAG = WheelView.class.getSimpleName();
     ...
     */
    private static final int[] SHADOWS_COLORS = new int[]{ResLoader.getColor(R.color.wheel_view_top_shadow), ResLoader.getColor(R.color.wheel_view_bottom_shadow)};
    /**
    ...
    private void initResourcesIfNecessary() {
        if (centerDrawable == null) {
            centerDrawable = ResLoader.getDrawable(R.drawable.wheel_focus_bg);
        }
    ...
    public View getTestItem(int index) {
        if (viewAdapter == null || viewAdapter.getItemsCount() == 0 || itemsLayout == null) {
            return null;
        }
        return itemsLayout.getChildAt(index);
    }
