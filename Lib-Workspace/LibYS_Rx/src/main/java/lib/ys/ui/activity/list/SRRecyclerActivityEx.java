 ...
 * @author yuansui
 */
abstract public class SRRecyclerActivityEx<T> extends RecyclerActivityEx<T> implements SROpt {

    private SROptImpl<T> mSROptImpl = new SROptImpl<T>(this, getWidget());
