 ...
 * @author yuansui
 */
abstract public class RecyclerFragEx<T> extends FragEx implements RecyclerViewOpt<T> {

    private RecyclerViewOptImpl<T> mWidget = new RecyclerViewOptImpl<T>(this);
