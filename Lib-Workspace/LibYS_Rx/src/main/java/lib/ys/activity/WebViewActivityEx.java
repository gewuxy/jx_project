...
abstract public class WebViewActivityEx extends ActivityEx {
...
//			}
    ...
    protected void updateFile(ValueCallback<Uri> uploadMsg) {
        ...
        WebViewActivityEx.this.startActivityForResult(Intent.createChooser(intent, "选择要使用的应用"), 1);
    }
    ...
    protected void updateFileForLollipop(ValueCallback<Uri[]> uploadMsg) {
        ...
        intent.addCategory(Intent.CATEGORY_OPENABLE);
        intent.setType("image/*");
        WebViewActivityEx.this.startActivityForResult(Intent.createChooser(intent, "选择要使用的应用"), 2);
    }
