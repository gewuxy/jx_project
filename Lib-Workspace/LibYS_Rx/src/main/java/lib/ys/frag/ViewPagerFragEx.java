...
abstract public class ViewPagerFragEx extends FragEx {
    ...
    private FragPagerAdapterInst mAdapter;
    ...
    protected final FragPagerAdapterInst getPagerAdapter() {
        if (mAdapter == null) {
    ...
    @NonNull
    protected FragPagerAdapterInst createPagerAdapter() {
        return new FragPagerAdapterInst(getChildFragmentManager());
    }
