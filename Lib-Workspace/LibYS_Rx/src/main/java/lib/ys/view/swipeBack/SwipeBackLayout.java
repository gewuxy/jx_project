...
public class SwipeBackLayout extends FrameLayout {
     ...
     */
    private static final int MIN_FLING_VELOCITY = 400; // dips per kSecond
    ...
    /**
     * Threshold of scroll, we will close the activity, when scrollPercent finish
     * this value;
     */
    ...
    public SwipeBackLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.SwipeBackLayout, defStyle, R.style.AppTheme_SwipeBack);
        ...
        int shadowLeft = a.getResourceId(R.styleable.SwipeBackLayout_shadow_left, R.mipmap.shadow_ic_left);
        int shadowRight = a.getResourceId(R.styleable.SwipeBackLayout_shadow_right, R.mipmap.shadow_ic_right);
        int shadowBottom = a.getResourceId(R.styleable.SwipeBackLayout_shadow_bottom, R.mipmap.shadow_ic_bottom);
...
//        mDragHelper.setEdgeSize(size);
    ...
    public static interface SwipeListener {
        ...
        /**
         * Invoke when scroll percent finish the threshold for the first time
         */
        public void onScrollOverThreshold();
    }

    /**
     * Set scroll threshold, we will close the activity, when scrollPercent finish
     * this value
     *
     * @param threshold
     */
    ...
    protected boolean drawChild(Canvas canvas, View child, long drawingTime) {
        ...
        if (mScrimOpacity > 0 && drawContent && mDragHelper.getViewDragState() != SwipeDragHelper.STATE_IDLE) {
    ...
    private class ViewDragCallback extends SwipeDragHelper.Callback {
        ...
        public void onViewPositionChanged(View changedView, int left, int top, int dx, int dy) {
            ...
            if (mSwipeListener != null && mDragHelper.getViewDragState() == STATE_DRAGGING && mScrollPercent >= mScrollThreshold && mIsScrollOverValid) {
