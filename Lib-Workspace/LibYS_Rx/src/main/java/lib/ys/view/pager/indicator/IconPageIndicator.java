...
public class IconPageIndicator extends HorizontalScrollView implements PageIndicator {
    ...
    public void onPageSelected(int position) {
        ...
        position = iconAdapter.isLoop() ? position % iconAdapter.getRealCount() : position;
    ...
    public void setIndicatorSpace(int px) {
        mIndicatorSpace = px;
    }
    ...
    public void notifyDataSetChanged() {
        ...
        IconPagerAdapter iconAdapter = (IconPagerAdapter) mViewPager.getAdapter();
        int count = iconAdapter.isLoop() ? iconAdapter.getRealCount() : iconAdapter.getCount();
        for (int i = 0; i < count; i++) {
            ImageView view = new ImageView(getContext(), null, R.attr.vpiIconPageIndicatorStyle);
            view.setImageResource(iconAdapter.getIndicatorResId(i));
    ...
    public void setCurrentItem(int item) {
        ...
        mSelectedIndex = item;
        if (!((IconPagerAdapter) mViewPager.getAdapter()).isLoop()) {
