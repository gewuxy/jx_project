...
import lib.sliding.menu.SlidingMenu.CanvasTransformer;
import lib.sliding.menu.SlidingMenu.OnClosedListener;
import lib.sliding.menu.SlidingMenu.OnOpenedListener;
...
public class CustomViewAbove extends ViewGroup {
    ...
    private boolean thisTouchAllowed(MotionEvent ev) {
        ...
        if (isMenuOpen()) {
            ...
            switch (mTouchMode) {
                case SlidingMenu.TOUCHMODE_FULLSCREEN://全屏状态下如果ev的坐标在View里面，return的是false
