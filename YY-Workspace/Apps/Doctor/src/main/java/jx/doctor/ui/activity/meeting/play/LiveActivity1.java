...
import jx.doctor.ui.activity.meeting.play.presenter.LivePresenterImpl1;
 ...
 */
@Route
public class LiveActivity1 extends BasePlayActivity1<LiveContract1.View, LiveContract1.Presenter> {
    ...
    @NonNull
    @Override
    protected LiveContract1.View createV() {
        return new LiveViewImpl1();
    }

    @NonNull
    @Override
    protected LiveContract1.Presenter createP(LiveContract1.View view) {
        return new LivePresenterImpl1(view);
    }
...
//            break;
    ...
    private class LiveViewImpl1 extends BasePlayViewImpl implements LiveContract1.View {
