 ...
 * @since : 2017/9/26
 */
public class PptLivePresenterImpl1 extends BasePlayPresenterImpl<PptLiveContract1.View> implements PptLiveContract1.Presenter {

    private WebSocket mWebSocket;

    public PptLivePresenterImpl1(PptLiveContract1.View view) {
        super(view);
    }
