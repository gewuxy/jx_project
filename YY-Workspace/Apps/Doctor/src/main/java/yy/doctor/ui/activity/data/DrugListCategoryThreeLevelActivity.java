...
public class DrugListCategoryThreeLevelActivity extends BaseListActivity<String, DrugListAdapter> {

    private EditText mEtPath;
    private String mPath;

    public static void nav(Context context, String path) {
        Intent i = new Intent(context, DrugListCategoryThreeLevelActivity.class);
    ...
    public void initNavBar(NavBar bar) {
        ...
        bar.addViewRight(R.mipmap.nav_bar_ic_data, v -> DrugListCategoryThreeLevelActivity.this.notify(NotifyType.data_finish));
    }
